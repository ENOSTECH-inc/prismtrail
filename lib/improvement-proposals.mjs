...
function normalizeAction(value = {}) {
  if (typeof value === "string") {
    return { proposal: clipped(value, 500), rationale: "", expectedEffect: "" };
  }
  return {
    proposal: clipped(value.proposal, 500),
    rationale: clipped(value.rationale, 500),
    expectedEffect: clipped(value.expectedEffect, 400)
  };
}

function normalizeSection(value = {}) {
  return {
    summary: clipped(value.summary, 500),
