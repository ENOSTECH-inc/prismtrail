...
export function createPrismTrailMcpTools(operations) {
  return [
    ...
    {
      name: "create_test_case", scope: "suites:write", description: "Add a new test case to a suite. Use relatedUrls as an array of up to 20 HTTP(S) provenance links.",
    ...
    {
      name: "update_test_case", scope: "suites:write", description: "Update one test case without deleting other cases. relatedUrls replaces the case's HTTP(S) provenance-link list when supplied.",
