...
export function createPrismTrailMcpTools(operations) {
  return [
    ...
    },
    {
      ...
      inputSchema: objectSchema({ suite: { type: "object" } }, ["suite"]),
    ...
    },
    {
      ...
      inputSchema: objectSchema({ suiteId: stringId, expectedUpdatedAt: { type: "string" }, patch: { type: "object" } }, ["suiteId", "expectedUpdatedAt", "patch"]),
      handler: (args, context) => operations.updateSuite(args, context)
    },
    {
      name: "create_test_case", scope: "suites:write", description: "Add a new test case to a suite.",
      inputSchema: objectSchema({ suiteId: stringId, expectedUpdatedAt: { type: "string" }, testCase: { type: "object" } }, ["suiteId", "expectedUpdatedAt", "testCase"]),
      handler: (args, context) => operations.createTestCase(args, context)
    },
    {
      name: "update_test_case", scope: "suites:write", description: "Update one test case without deleting other cases.",
      inputSchema: objectSchema({ suiteId: stringId, caseId: stringId, expectedUpdatedAt: { type: "string" }, patch: { type: "object" } }, ["suiteId", "caseId", "expectedUpdatedAt", "patch"]),
