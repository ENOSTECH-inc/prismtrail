...
export const SHEET_SCHEMA_VERSION = "6";
const SUPPORTED_SHEET_SCHEMA_VERSIONS = ["1", "2", "3", "4", "5", SHEET_SCHEMA_VERSION];
...
export function reportToRows(report) {
  ...
  return [
    ...
    ["", "◆ ビジネス要件は紫色の列（H〜O）、レスポンス受領は末尾の専用列に表示されます"],
...
export function writeReportSheet(spreadsheetId, report) {
  return writeFixedSheet(spreadsheetId, REPORT_SHEET, reportToRows(report), 15, {
    columnWidths: [150, 230, 105, 100, 115, 110, 320, 90, 75, 105, 130, 320, 420, 300, 170, 125, 145, 175, 250, 125, 115],
