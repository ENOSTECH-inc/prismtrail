...
export const GOOGLE_CUSTOM_OAUTH_ADC_COMMAND =
  `gcloud auth application-default login --client-id-file=OAUTH_CLIENT_FILE --scopes=${GOOGLE_ADC_SCOPE_LIST}`;
...
export function googleAuthSetupOptions(projectId = "") {
  return [
    ...
    },
    {
      ...
      keyless: true,
      commands: [
        GOOGLE_CUSTOM_OAUTH_ADC_COMMAND,
        GOOGLE_USER_ADC_QUOTA_COMMAND.replace("GOOGLE_CLOUD_PROJECT", projectId || "GOOGLE_CLOUD_PROJECT")
      ],
      docsUrl: "https://cloud.google.com/docs/authentication/troubleshoot-adc#access_blocked_when_using_scopes",
      securityDocsUrl: null
    }
  ];
}
