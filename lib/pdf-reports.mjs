    ...
    const improvementPages = proposal?.status === "succeeded"
      ? (() => {
          ...
          return Array.from({ length: pageCount }, (_, proposalPageIndex) => ({
            ...
            improvementBody0: pagesBySection[0][proposalPageIndex] || "（前ページに掲載）",
            improvementBody1: pagesBySection[1][proposalPageIndex] || "（前ページに掲載）",
            improvementBody2: pagesBySection[2][proposalPageIndex] || "（前ページに掲載）",
            improvementBody3: pagesBySection[3][proposalPageIndex] || "（前ページに掲載）",
