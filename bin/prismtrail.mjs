...
const skillPath = path.join(rootDirectory, "skills", "prismtrail", "SKILL.md");
...
export function serializeEnv(values) {
  ...
  return [
    "# Generated by PrismTrail. This file may contain environment-specific identifiers.",
    "# Do not commit it.",
...
function printHelp() {
  console.log(`PrismTrail setup CLI
